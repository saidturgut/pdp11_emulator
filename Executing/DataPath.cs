...
public partial class DataPath
{
    ...
    public void Init()
    {
        Access(RegisterAction.R0).Set(1);
        Access(RegisterAction.R1).Set(2);
        Access(RegisterAction.R2).Set(0x7FFF);
        Access(RegisterAction.R3).Set(128);
        Access(RegisterAction.R4).Set(0x8000);
        Access(RegisterAction.R5).Set(0x8000);
